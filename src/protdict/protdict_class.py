...
class Data:
    ...
    def _set_new_val( self, name:str, value: Any, *, essential: bool = False, protected: bool = False, frozen: bool = False, 
        hidden: bool = False, types:str|list[str]|type|list[type]|None = None, description: str = "", source: str = "", 
        metadata: Any = None, tags:str|list[str]|None = None,override:bool=False):
        ...
        newval:DataVal = DataVal(value,essential=essential,protected=protected,frozen=frozen,hidden=hidden,types=types,tags=tags,
    ...
    def set(self, name:str, value: Any, *, essential: bool = False, protected: bool = False, frozen: bool = False, 
        ...
        self._set_new_val(name,value,essential=essential,protected=protected,frozen=frozen,hidden=hidden,types=types,tags=tags,
